...
import static de.kreth.clubhelper.messungen.aspects.AbstractLoggerAspect.LogLevel.DEBUG;
import static de.kreth.clubhelper.messungen.aspects.AbstractLoggerAspect.LogLevel.ERROR;
...
public class ControllerLoggerAspect extends AbstractLoggerAspect {
    ...
    @Pointcut("execution (public * de.kreth.clubhelper.messungen.remote..*(..))")
